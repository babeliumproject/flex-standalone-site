...
NOTE: you might want to check this other blog post 
http://hendrelouw73.wordpress.com/2013/03/06/how-to-install-oracle-java-7-update-17-on-ubuntu-12-04-linux/
about how to install Oracle JDK 1.7 from the command line (the webupd8team installer has an X11 dependency that might not 
