package modules.home.command
{
	...
	public class SignedMessageOfTheDayCommand implements ICommand, IResponder
	{
		...
		public function fault(info:Object):void
		{
			...
			CustomAlert.error(ResourceManager.getInstance().getString('myResources','ERROR_WHILE_RETRIEVING_MOTD'));
		}
	}
}