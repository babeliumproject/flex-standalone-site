package commands.exercises
{
	...
	public class SubCreditsForEvalRequestCommand implements ICommand, IResponder
	{

		public function execute(event:CairngormEvent):void
		{
			//Commands delegate service calls to a Delegate
			new CreditsDelegate(this).subCreditsForEvalRequest((event as CreditEvent).userId);
		}
		...
		public function fault(info:Object):void
		{
			...
			Alert.show("Error While Changing Credit Amount:"+faultEvent.message);
