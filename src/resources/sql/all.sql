...
(1, 'kutsidazu_zatia', 'Kutsidazu bidea ixabel filmeko zatia', 'Red5', 'Basque', 1, 'euskaltegia, berri', 'Kutsidazu bidea ixabel', 'kutsidazu_zatia.jpg', '2009-09-01 00:24:04', 130, 'Unavailable', '6990471c4ac782c4329a662b061e17e2', NULL),
(2, 'serie_cuatro', 'Escena de serie', 'Red5', 'Spanish', 1, 'cuatro, serie', 'Extracto serie', 'serie_cuatro.jpg', '2009-09-01 00:24:04', 10, 'Unavailable', '9d9bd82503637191e53ef955f9ea0ea4', NULL),
(3, 'mafiosos_conv', 'Conversación entre mafiosos', 'Red5', 'Spanish', 1, 'serie, mafiosos', 'Conversación mafiosos', 'mafiosos_conv.jpg', '2010-02-02 00:23:33', 38, 'Unavailable', 'bc1f4ee5459657d761e70582d6c12bfc', NULL),
(4, 'pokemon_zatia', 'Pokemon marrazki bizidunen zatia', 'Red5', 'Basque', 1, 'pokemon, zatia', 'Pokemon zatia', 'pokemon_zatia.jpg', '2010-02-02 01:23:34', 84, 'Unavailable', '00c843cdaccae236dc4e33f6bf9423c6', NULL),
(5, 'tdes_1065_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'English', 1, 'daily, english, show', 'The Daily English Show #1065 Fragment', 'tdes_1065_qa.jpg', '2010-03-08 12:10:00', 43, 'Available', '161abc5e831c545305f55f4139fd4799', NULL),
(6, 'tdes_1170_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'English', 1, 'daily, english, show', 'The Daily English Show #1170 Fragment', 'tdes_1170_qa.jpg', '2010-03-08 12:10:00', 52, 'Available', '38b99457f8cd8af5b56728c5e2f0485b', NULL),
(7, 'tdes_1179_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'English', 1, 'daily, english, show', 'The Daily English Show #1179 Fragment', 'tdes_1179_qa.jpg', '2010-03-08 12:10:00', 30, 'Available', '4fe59e622c208b53dc4e61cfdcb7b2a8', NULL),
(8, 'tdes_1183_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'English', 1, 'daily, english, show', 'The Daily English Show #1183 Fragment', 'tdes_1183_qa.jpg', '2010-03-08 12:10:00', 40, 'Available', '2f8d1bde45ae7a7d303d663bcdf2ae8c', NULL),
(9, 'tdes_1187_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'English', 1, 'daily, english, show', 'The Daily English Show #1187 Fragment', 'tdes_1187_qa.jpg', '2010-03-08 12:10:00', 57, 'Available', 'a0cd07a3ac94d2dbf77ca1c02c6278cc', NULL),
(10, 'english_long', 'english lessons', 'Red5', 'English', 1, 'english', 'English lessons', 'english_long.jpg', '2009-10-22 18:00:00', 59, 'Unavailable', 'e1fdbb47ead995d5973a30d466e7533d', NULL),
(11, 'english', 'english lessons', 'Red5', 'English', 1, 'english', 'English lessons short', 'english.jpg', '2009-10-22 18:00:00', 12, 'Unavailable', 'fc1b11475ce5233acf10bfb39925cacc', 1),
...
(15, 'COSYB49sT1G', 'Frases sencillas de la vida cotidiana', 'Red5', 'Spanish', 1, 'frases, cotidianas', 'Español Latino Para Niños', 'COSYB49sT1G.jpg', '2010-04-15 13:21:45', 63, 'Available', '4878a56679f48167686adc80e267506f', NULL);
...
(1, 'initialCredits', '15'),
(2, 'subtitleAdditionCredits', '2'),
(3, 'evaluationRequestCredits', '2'),
(4, 'evaluatedWithVideoCredits', '2'),
(5, 'videoSuggestCredits', '2'),
(6, 'dailyLoginCredits', '0.5'),
(7, 'evaluatedWithCommentCredits', '1.5'),
(8, 'evaluatedWithScoreCredits', '0.5'),
(9, 'subtitleTranslationCredits', '1.5'),
(10, 'uploadExerciseCredits', '2'),
(11, 'dbrevision', '$Revision$'),
(12, 'appRevision', '0'),
(13, 'trial.threshold', '10'),
(14, 'hashLength', '20'),
(15, 'hashChars', 'abcdefghijklmnopqrstuvwxyz0123456789-_'),
(16, 'ffmpeg.path', '/usr/bin/ffmpeg'),
(17, 'spinvox.useragent', 'babelia'),
(18, 'spinvox.language', 'English'),
(19, 'spinvox.appname', 'babelia-auto_correction'),
(20, 'spinvox.account_id', '2009-2385-6238-3307'),
(21, 'spinvox.password', 'kviAcV6a'),
(22, 'spinvox.protocol', 'https'),
(23, 'spinvox.username', 'babelia2009'),
(24, 'spinvox.port', '443'),
...
(29, 'spinvox.video_path', '/opt/red5/webapps/oflaDemo/streams'),
(30, 'spinvox.temp_folder', '/tmp'),
(31, 'spinvox.max_duration', '30'),
(32, 'spinvox.dev_mode', 'true'),
(33, 'videoCommentPath', '/usr/lib/red5/webapps/oflaDemo/streams/videoComment/'),
...
(5, 5, 1, 'English', 0, '2010-04-19 14:25:22'),
(6, 6, 1, 'English', 0, '2010-04-19 14:25:22'),
(7, 7, 1, 'English', 0, '2010-04-19 14:25:22'),
(8, 8, 1, 'English', 0, '2010-04-19 14:25:22'),
(9, 9, 1, 'English', 0, '2010-04-19 14:25:22');
