...
CREATE TABLE IF NOT EXISTS `evaluation` (
  ...
  `score_overall` TINYINT NULL DEFAULT 0, 
  `score_intonation` TINYINT UNSIGNED NULL DEFAULT 0, 
  `score_fluency` TINYINT UNSIGNED NULL DEFAULT 0, 
  `score_rhythm` TINYINT UNSIGNED NULL DEFAULT 0, 
  `score_spontaneity` TINYINT UNSIGNED NULL DEFAULT 0,
  `comment` text,
  PRIMARY KEY (`id`),
...
(2, 'serie_cuatro', 'Escena de serie', 'Red5', 'es_ES', 1, 'cuatro, serie', 'Extracto serie', 'serie_cuatro.jpg', '2009-09-01 00:24:04', 10, 'Unavailable', '9d9bd82503637191e53ef955f9ea0ea4', NULL, 'http://www.cuatro.com'),
(3, 'mafiosos_conv', 'Conversación entre mafiosos', 'Red5', 'es_ES', 1, 'serie, mafiosos', 'Conversación mafiosos', 'mafiosos_conv.jpg', '2010-02-02 00:23:33', 38, 'Unavailable', 'bc1f4ee5459657d761e70582d6c12bfc', NULL, 'http://www.eitb.com'),
(4, 'pokemon_zatia', 'Pokemon marrazki bizidunen zatia', 'Red5', 'eu_ES', 1, 'pokemon, zatia', 'Pokemon zatia', 'pokemon_zatia.jpg', '2010-02-02 01:23:34', 84, 'Unavailable', '00c843cdaccae236dc4e33f6bf9423c6', NULL, 'http://www.eitb.com'),
(5, 'tdes_1065_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'en_US', 1, 'daily, english, show', 'The Daily English Show #1065 Fragment', 'tdes_1065_qa.jpg', '2010-03-08 12:10:00', 43, 'Available', '161abc5e831c545305f55f4139fd4799', NULL, 'http://www.thedailyenglishshow.com'),
(6, 'tdes_1170_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'en_US', 1, 'daily, english, show', 'The Daily English Show #1170 Fragment', 'tdes_1170_qa.jpg', '2010-03-08 12:10:00', 52, 'Available', '38b99457f8cd8af5b56728c5e2f0485b', NULL, 'http://www.thedailyenglishshow.com'),
(7, 'tdes_1179_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'en_US', 1, 'daily, english, show', 'The Daily English Show #1179 Fragment', 'tdes_1179_qa.jpg', '2010-03-08 12:10:00', 30, 'Available', '4fe59e622c208b53dc4e61cfdcb7b2a8', NULL, 'http://www.thedailyenglishshow.com'),
(8, 'tdes_1183_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'en_US', 1, 'daily, english, show', 'The Daily English Show #1183 Fragment', 'tdes_1183_qa.jpg', '2010-03-08 12:10:00', 40, 'Available', '2f8d1bde45ae7a7d303d663bcdf2ae8c', NULL, 'http://www.thedailyenglishshow.com'),
(9, 'tdes_1187_qa', 'Repeat phrases and then talk to Sarah', 'Red5', 'en_US', 1, 'daily, english, show', 'The Daily English Show #1187 Fragment', 'tdes_1187_qa.jpg', '2010-03-08 12:10:00', 57, 'Available', 'a0cd07a3ac94d2dbf77ca1c02c6278cc', NULL, 'http://www.thedailyenglishshow.com'),
...
(13, '08s08c4o3El', 'Goenkale telesaileko zati bat', 'Red5', 'eu_ES', 1, 'euskara, goenkale', 'Goenkale Zatia I', '08s08c4o3El.jpg', '2010-04-15 13:18:14', 38, 'Available', 'f03a80496520e2d275cef027b69aa379', NULL, 'http://www.eitb.com'),
(14, 'iQ8pI4bFwQh', 'Goenkale telesaileko zatia', 'Red5', 'eu_ES', 1, 'euskara, goenkale', 'Goenkale Zatia II', 'iQ8pI4bFwQh.jpg', '2010-04-15 13:19:33', 110, 'Available', '632fbbf33993892b9794f1cc324cd8d1', NULL, 'http://www.eitb.com'),
